...
__export(daily_esm_exports, {
  DAILY_ACCESS_LEVEL_FULL: () => Ir,
  DAILY_ACCESS_LEVEL_LOBBY: () => Lr,
  DAILY_ACCESS_LEVEL_NONE: () => Nr,
  DAILY_ACCESS_UNKNOWN: () => Dr,
  ...
  DAILY_EVENT_ERROR: () => so,
  DAILY_EVENT_EXIT_FULLSCREEN: () => Xi,
  DAILY_EVENT_FACE_COUNTS_UPDATED: () => Qi,
  DAILY_EVENT_FULLSCREEN: () => Ki,
  ...
  DAILY_EVENT_NETWORK_CONNECTION: () => Wi,
  DAILY_EVENT_NETWORK_QUALITY_CHANGE: () => zi,
  DAILY_EVENT_NONFATAL_ERROR: () => ao,
  ...
  DAILY_EVENT_RECEIVE_SETTINGS_UPDATED: () => io,
  DAILY_EVENT_RECORDING_DATA: () => Ni,
  DAILY_EVENT_RECORDING_ERROR: () => Ii,
  DAILY_EVENT_RECORDING_STARTED: () => xi,
  DAILY_EVENT_RECORDING_STATS: () => Di,
  DAILY_EVENT_RECORDING_STOPPED: () => ji,
  DAILY_EVENT_RECORDING_UPLOAD_COMPLETED: () => Li,
  DAILY_EVENT_REMOTE_MEDIA_PLAYER_STARTED: () => Bi,
  ...
  DAILY_EVENT_TRANSCRIPTION_ERROR: () => Ai,
  DAILY_EVENT_TRANSCRIPTION_MSG: () => Fi,
  ...
  DAILY_FATAL_ERROR_CONNECTION: () => Wr,
  DAILY_FATAL_ERROR_EJECTED: () => Br,
  ...
  DAILY_FATAL_ERROR_NOT_ALLOWED: () => zr,
  DAILY_FATAL_ERROR_NO_ROOM: () => qr,
  DAILY_RECEIVE_SETTINGS_ALL_PARTICIPANTS_KEY: () => Fr,
  ...
  DAILY_TRACK_STATE_INTERRUPTED: () => xr,
  DAILY_TRACK_STATE_LOADING: () => Ar,
...
function I(e2, t2, n2) {
  for (n2 of e2.keys()) if (L(n2, t2)) return n2;
}
function L(e2, t2) {
  var n2, r2, i2;
  ...
  if (e2 && t2 && (n2 = e2.constructor) === t2.constructor) {
    ...
    if (n2 === Array) {
      if ((r2 = e2.length) === t2.length) for (; r2-- && L(e2[r2], t2[r2]); ) ;
      return -1 === r2;
    }
    if (n2 === Set) {
    ...
    if (n2 === Map) {
      ...
      for (r2 of e2) {
        ...
        if (!L(r2[1], t2.get(i2))) return false;
      }
      return true;
    }
    ...
    if (!n2 || "object" == typeof e2) {
      for (n2 in r2 = 0, e2) {
        if (D.call(e2, n2) && ++r2 && !D.call(t2, n2)) return false;
        if (!(n2 in t2) || !L(e2[n2], t2[n2])) return false;
      }
...
function X(e2) {
  return null != e2 && e2.callObjectBundleUrlOverride ? e2.callObjectBundleUrlOverride : K("https://c.daily.co/call-machine/versioned/".concat("0.66.0", "/static/call-machine-object-bundle.js"), e2);
}
function Z(e2) {
  try {
    new URL(e2);
...
function Ue(e2) {
  if (te(e2)) return { message: e2.message, name: e2.name, stack: e2.stack, ...$e(e2) };
  if (ce(e2)) {
...
function qe(e2, t2) {
  if (se(e2)) {
    ...
    const r2 = {};
    t2.set(e2, r2);
    for (const n3 of Object.keys(e2)) void 0 !== e2[n3] && (r2[n3] = qe(e2[n3], t2));
    return r2;
  }
  if (Array.isArray(e2)) {
    const n2 = t2.get(e2);
...
function wt(e2, t2, n2 = 1 / 0, r2 = 1 / 0, i2 = /* @__PURE__ */ function() {
  ...
  const c2 = function(e3, t3) {
    try {
      ...
      if ("function" == typeof t3) return `[Function: ${Je(t3)}]`;
...
function Tt(e2) {
  ...
  return { $: t2, add: function(r2) {
    if (!(void 0 === e2 || t2.length < e2)) return Et(new Le("Not adding Promise because buffer limit was reached."));
    const i2 = r2();
...
function Bt(e2, t2) {
  ...
  function o2(e3) {
    "string" == typeof i2 ? i2 = "string" == typeof e3 ? i2 + e3 : [Ft(i2, t2), e3] : i2.push("string" == typeof e3 ? Ft(e3, t2) : e3);
  }
  for (const e3 of r2) {
    const [t3, n3] = e3;
    if (o2(`
...
function Ut(e2, t2) {
  const n2 = "string" == typeof e2.data ? Ft(e2.data, t2) : e2.data;
...
function zt(e2) {
  const t2 = It(), n2 = { sid: pt(), init: true, timestamp: t2, started: t2, duration: 0, status: "ok", errors: 0, ignoreDuration: false, toJSON: () => function(e3) {
...
function pn(e2, t2, n2, r2) {
  const { normalizeDepth: i2 = 3, normalizeMaxBreadth: o2 = 1e3 } = e2, a2 = { ...t2, event_id: t2.event_id || n2.event_id || pt(), timestamp: t2.timestamp || Dt() }, s2 = n2.integrations || e2.integrations.map((e3) => e3.name);
  !function(e3, t3) {
...
function bn(e2, t2, n2 = Tt(e2.bufferSize || _n)) {
  ...
  function i2(i3) {
    ...
    const a2 = Lt(i3[0], o2), s2 = (t3) => {
      Rt(a2, (n3, r3) => {
        const i4 = wn(n3, r3);
        e2.recordDroppedEvent(t3, $t(r3), i4);
      });
    };
    return n2.add(() => t2({ body: Bt(a2, e2.textEncoder) }).then((e3) => (void 0 !== e3.statusCode && (e3.statusCode < 200 || e3.statusCode >= 300) && ("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && Ae.warn(`Sentry responded with status code ${e3.statusCode} to sent event.`), r2 = Yt(r2, e3), e3), (e3) => {
      throw s2("network_error"), e3;
    })).then((e3) => e3, (e3) => {
      if (e3 instanceof Le) return ("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && Ae.error("Skipped sending event because buffer is full."), s2("queue_overflow"), kt();
      throw e3;
    });
  }
...
function Dn(e2, t2 = {}, n2) {
  ...
  Fe(r2, e2), Re(e2, "__sentry_wrapped__", r2);
  try {
...
function Bn(e2, t2, n2, r2, i2) {
  let o2;
  if (re(t2) && t2.error) {
    return Ln(e2, t2.error);
  }
  if (ie(t2) || ne(t2, "DOMException")) {
    const i3 = t2;
    if ("stack" in t2) o2 = Ln(e2, t2);
    else {
...
function Zn() {
  nt("error", (e2) => {
    ...
    }(i2, o2, a2, s2) : tr(Bn(n2, c2 || i2, void 0, r2, false), o2, a2, s2);
...
function er() {
  nt("unhandledrejection", (e2) => {
    ...
    const o2 = ae(i2) ? { exception: { values: [{ type: "UnhandledRejection", value: `Non-Error promise rejection captured with value: ${String(i2)}` }] } } : Bn(n2, i2, void 0, r2, true);
...
function ar(e2) {
  return function(...t2) {
    const n2 = t2[0];
    return t2[0] = Dn(n2, { mechanism: { data: { function: Je(e2) }, handled: true, type: "instrument" } }), e2.apply(this, t2);
  };
}
function sr(e2) {
  return function(t2) {
    return e2.apply(this, [Dn(t2, { mechanism: { data: { function: "requestAnimationFrame", handler: Je(e2) }, handled: true, type: "instrument" } })]);
  };
}
function cr(e2) {
  return function(...t2) {
    ...
    return ["onload", "onerror", "onprogress", "onreadystatechange"].forEach((e3) => {
      e3 in n2 && "function" == typeof n2[e3] && Ne(n2, e3, function(t3) {
        const n3 = { mechanism: { data: { function: e3, handler: Je(t3) }, handled: true, type: "instrument" } }, r2 = Be(t3);
        return r2 && (n3.mechanism.data.handler = Je(r2)), Dn(t3, n3);
      });
    }), e2.apply(this, t2);
  };
}
function lr(e2) {
  ...
  n2 && n2.hasOwnProperty && n2.hasOwnProperty("addEventListener") && (Ne(n2, "addEventListener", function(t3) {
    return function(n3, r2, i2) {
      try {
        "function" == typeof r2.handleEvent && (r2.handleEvent = Dn(r2.handleEvent, { mechanism: { data: { function: "handleEvent", handler: Je(r2), target: e2 }, handled: true, type: "instrument" } }));
      } catch (e3) {
      }
      return t3.apply(this, [n3, Dn(r2, { mechanism: { data: { function: "addEventListener", handler: Je(r2), target: e2 }, handled: true, type: "instrument" } }), i2]);
    };
...
function Oo() {
  ...
  return !ko() && (!!Co && (e2 ? function() {
    if (jo()) return false;
    return ["Chrome", "Firefox"].includes(Do());
  }() : function() {
    if (jo()) return false;
    var e3 = Do();
    if ("Safari" === e3) {
...
function Ao() {
  return !ko() && (!jo() && ("undefined" != typeof AudioWorkletNode && Po.includes(Do())));
}
function xo() {
  return Eo() && !function() {
    var e2, t2 = Do();
    ...
    switch (t2) {
      case "Chrome":
        return (e2 = Lo()).major && e2.major > 0 && e2.major < 75;
      case "Firefox":
        return (e2 = Fo()).major < 91;
      case "Safari":
        return (e2 = Ro()).major < 13 || 13 === e2.major && e2.minor < 1;
      default:
        return true;
    }
  }();
...
function Do() {
  if ("undefined" != typeof window) {
    var e2 = So();
    return No() ? "Safari" : e2.indexOf("Edge") > -1 ? "Edge" : e2.match(/Chrome\//) ? "Chrome" : e2.indexOf("Safari") > -1 ? "Safari" : e2.indexOf("Firefox") > -1 ? "Firefox" : e2.indexOf("MSIE") > -1 || e2.indexOf(".NET") > -1 ? "IE" : "Unknown Browser";
  }
}
function Io() {
  switch (Do()) {
...
function No() {
  return !!So().match(/iPad|iPhone|iPod/i) && Eo();
}
function Ro() {
  var e2 = 0, t2 = 0, n2 = 0;
  if ("undefined" != typeof window) {
...
function Ko(e2) {
  ...
  return Ko = function(e3) {
    ...
    function r2() {
      return Qo(e3, arguments, u(this).constructor);
    }
...
function fa(e2, t2) {
  try {
    var n2 = t2.getState();
    for (var r2 in e2.tracks) if (!ga(r2)) {
      var i2 = e2.tracks[r2].kind;
      if (i2) {
        var o2 = e2.tracks[r2];
        if (o2) {
          var a2 = e2.local ? ha(n2, r2) : la(n2, e2.session_id, r2, i2);
...
function ma(e2, t2, n2) {
  ...
  if (e2.local) {
    ...
    try {
      ...
      if (e2.screen && sa(r2, e2.session_id, "screen-video")) {
...
function va(e2, t2) {
  ...
  if (!n2) {
    if (Array.isArray(e2) || (n2 = function(e3, t3) {
      ...
      if ("Arguments" === n3 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n3)) return ya(e3, t3);
...
function wa(e2, t2) {
  ...
  if (!n2) {
    if (Array.isArray(e2) || (n2 = function(e3, t3) {
      ...
      "Object" === n3 && e3.constructor && (n3 = e3.constructor.name);
      if ("Map" === n3 || "Set" === n3) return Array.from(e3);
      if ("Arguments" === n3 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n3)) return Sa(e3, t3);
    }(e2)) || t2 && e2 && "number" == typeof e2.length) {
      n2 && (e2 = n2);
      var r2 = 0, i2 = function() {
      };
...
function Ta(e2) {
  Oa() ? function(e3) {
    _a.has(e3) || (_a.set(e3, {}), navigator.mediaDevices.enumerateDevices().then(function(t2) {
      _a.has(e3) && (_a.get(e3).lastDevicesString = JSON.stringify(t2), ba || (ba = function() {
        var e4 = p(function* () {
          var e5, t3 = yield navigator.mediaDevices.enumerateDevices(), n2 = va(_a.keys());
          try {
      ...
      }(), navigator.mediaDevices.addEventListener("devicechange", ba)));
    }).catch(function() {
    }));
  }(e2) : function(e3) {
    ka.has(e3) || (ka.set(e3, {}), navigator.mediaDevices.enumerateDevices().then(function(t2) {
      ka.has(e3) && (ka.get(e3).lastDevicesString = JSON.stringify(t2), Ea || (Ea = setInterval(p(function* () {
...
function Ca(e2) {
  Oa() ? function(e3) {
    _a.has(e3) && (_a.delete(e3), 0 === _a.size && ba && (navigator.mediaDevices.removeEventListener("devicechange", ba), ba = null));
  }(e2) : function(e3) {
    ka.has(e3) && (ka.delete(e3), 0 === ka.size && Ea && (clearInterval(Ea), Ea = null));
  }(e2);
}
function Oa() {
...
function Aa(e2, t2) {
  ...
  return e2 && "live" === e2.readyState && !function(e3, t3) {
    return (!t3.isLocalScreenVideo || "Chrome" !== Do()) && e3.muted && !Pa.has(e3.id);
...
function Fa(e2, t2) {
  ...
  if (!n2) {
    if (Array.isArray(e2) || (n2 = function(e3, t3) {
      ...
      "Object" === n3 && e3.constructor && (n3 = e3.constructor.name);
      if ("Map" === n3 || "Set" === n3) return Array.from(e3);
      if ("Arguments" === n3 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n3)) return Ba(e3, t3);
    }(e2)) || t2 && e2 && "number" == typeof e2.length) {
      n2 && (e2 = n2);
      var r2 = 0, i2 = function() {
      };
...
function ls(e2) {
  ...
  if ("string" == typeof e2) t2 = e2;
    ...
    t2 = JSON.stringify(e2), L(JSON.parse(t2), e2) || console.warn("The userData provided will be modified when serialized.");
  } catch (e3) {
...
function ds(e2) {
  ...
  }), t2 = r2.type, "string" != typeof t2 || !Object.values(mo).includes(t2) && (console.error("inputSettings audio processor type invalid"), 1))))));
  var t2, r2, i2;
}
function hs(e2, t2) {
  var n2, r2 = [];
  e2.video && !Oo(null !== (n2 = null == t2 ? void 0 : t2.useLegacyVideoProcessor) && void 0 !== n2 && n2) && (delete e2.video, r2.push("video")), e2.audio && !Ao() && (delete e2.audio, r2.push("audio")), r2.length > 0 && console.error("Ignoring settings for browser- or platform-unsupported input processor(s): ".concat(r2.join(", ")));
}
function ps() {
...
function fs(e2) {
  ...
  return "receiveSettings must be of the form { [<remote participant id> | ".concat(Rr).concat(t2 ? ' | "'.concat(Fr, '"') : "", "]: ") + '{ [video: [{ layer: [<non-negative integer> | "inherit"] } | "inherit"]], [screenVideo: [{ layer: [<non-negative integer> | "inherit"] } | "inherit"]] }}}';
}
function gs() {
  return "customIntegrations should be an object of type ".concat(JSON.stringify(Ha), ".");
}
function ms(e2) {
  if (e2 && "object" !== n(e2) || Array.isArray(e2)) return console.error("customTrayButtons should be an Object of the type ".concat(JSON.stringify(Wa), ".")), false;
...
function vs(e2) {
  ...
  for (var t2 = function(e3) {
    return "".concat(e3, " should be ").concat(Ha.id[e3]);
  }, r2 = function(e3, t3) {
    ...
    for (var s2 = 0, c2 = Object.entries(e2[a2]); s2 < c2.length; s2++) {
      ...
      switch (u2) {
        ...
        case "shared":
          ...
          break;
        default:
          if (!Ha.id[u2]) return console.error("customIntegration does not support key ".concat(u2)), false;
      }
    }
  }
  return true;
...
function _s(e2) {
  ...
  if (e2.state && !Object.values(vo).includes(e2.state)) throw new Error("Invalid value for RemoteMediaPlayerSettings.state, valid values are: " + JSON.stringify(vo));
  if (e2.volume) {
...
var m, v, y, _, b, w, k, D, N, R, F, B, U, V, $, G, q, Y, J, z, W, ee, be, ke, Ee, Ce, Ae, xe, Le, Ye, ze, Qe, Ke, Xe, Ze, et, at, st, ct, lt, dt, ht, St, Mt, Ot, Pt, At, xt, jt, Dt, It, Vt, qt, Jt, Ht, Zt, en, tn, cn, dn, fn, gn, mn, _n, Sn, kn, En, Mn, Tn, Cn, Pn, An, xn, Rn, $n, Gn, qn, Hn, Qn, Xn, ir, or, ur, dr, hr, vr, yr, _r, br, wr, Sr, kr, Er, Mr, Tr, Cr, Or, Pr, Ar, xr, jr, Dr, Ir, Lr, Nr, Rr, Fr, Br, Ur, Vr, $r, Gr, qr, Yr, Jr, zr, Wr, Hr, Qr, Kr, Xr, Zr, ei, ti, ni, ri, ii, oi, ai, si, ci, li, ui, di, hi, pi, fi, gi, mi, vi, yi, _i, bi, wi, Si, ki, Ei, Mi, Ti, Ci, Oi, Pi, Ai, xi, ji, Di, Ii, Li, Ni, Ri, Fi, Bi, Ui, Vi, $i, Gi, qi, Yi, Ji, zi, Wi, Hi, Qi, Ki, Xi, Zi, eo, to, no, ro, io, oo, ao, so, co, lo, uo, ho, po, fo, go, mo, vo, yo, _o, bo, wo, Co, Po, Bo, Go, Yo, Jo, zo, Wo, Ho, ea, ta, na, ra, ia, oa, aa, sa, ca, la, ua, da, ha, _a, ba, ka, Ea, Ma, Pa, xa, ja, Da, Ia, Ua, Va, $a, Ga, qa, Ya, Ja, za, Wa, Ha, Qa, Ka, Xa;
var init_daily_esm = __esm({
  "node_modules/@daily-co/daily-js/dist/daily-esm.js"() {
    ...
    F = { tablet: "tablet", mobile: "mobile", desktop: "desktop", tv: "tv" };
    ...
    Y = [{ test: [/googlebot/i], describe: () => ({ type: "bot", vendor: "Google" }) }, { test: [/huawei/i], describe(e2) {
      const t2 = V.getFirstMatch(/(can-l01)/i, e2) && "Nova", n2 = { type: F.mobile, vendor: "Huawei" };
      return t2 && (n2.model = t2), n2;
    } }, { test: [/nexus\s*(?:7|8|9|10).*/i], describe: () => ({ type: F.tablet, vendor: "Nexus" }) }, { test: [/ipad/i], describe: () => ({ type: F.tablet, vendor: "Apple", model: "iPad" }) }, { test: [/Macintosh(.*?) FxiOS(.*?)\//], describe: () => ({ type: F.tablet, vendor: "Apple", model: "iPad" }) }, { test: [/kftt build/i], describe: () => ({ type: F.tablet, vendor: "Amazon", model: "Kindle Fire HD 7" }) }, { test: [/silk/i], describe: () => ({ type: F.tablet, vendor: "Amazon" }) }, { test: [/tablet(?! pc)/i], describe: () => ({ type: F.tablet }) }, { test(e2) {
      const t2 = e2.test(/ipod|iphone/i), n2 = e2.test(/like (ipod|iphone)/i);
      return t2 && !n2;
    }, describe(e2) {
      const t2 = V.getFirstMatch(/(ipod|iphone)/i, e2);
      return { type: F.mobile, vendor: "Apple", model: t2 };
    } }, { test: [/nexus\s*[0-6].*/i, /galaxy nexus/i], describe: () => ({ type: F.mobile, vendor: "Nexus" }) }, { test: [/[^-]mobi/i], describe: () => ({ type: F.mobile }) }, { test: (e2) => "blackberry" === e2.getBrowserName(true), describe: () => ({ type: F.mobile, vendor: "BlackBerry" }) }, { test: (e2) => "bada" === e2.getBrowserName(true), describe: () => ({ type: F.mobile }) }, { test: (e2) => "windows phone" === e2.getBrowserName(), describe: () => ({ type: F.mobile, vendor: "Microsoft" }) }, { test(e2) {
      const t2 = Number(String(e2.getOSVersion()).split(".")[0]);
      return "android" === e2.getOSName(true) && t2 >= 3;
    }, describe: () => ({ type: F.tablet }) }, { test: (e2) => "android" === e2.getOSName(true), describe: () => ({ type: F.mobile }) }, { test: (e2) => "macos" === e2.getOSName(true), describe: () => ({ type: F.desktop, vendor: "Apple" }) }, { test: (e2) => "windows" === e2.getOSName(true), describe: () => ({ type: F.desktop }) }, { test: (e2) => "linux" === e2.getOSName(true), describe: () => ({ type: F.desktop }) }, { test: (e2) => "playstation 4" === e2.getOSName(true), describe: () => ({ type: F.tv }) }, { test: (e2) => "roku" === e2.getOSName(true), describe: () => ({ type: F.tv }) }];
    ...
    xt = "undefined" != typeof __SENTRY_BROWSER_BUNDLE__ && __SENTRY_BROWSER_BUNDLE__ || "[object process]" !== Object.prototype.toString.call("undefined" != typeof process ? process : 0) ? function() {
    ...
    jt = void 0 === xt ? At : { nowSeconds: () => (xt.timeOrigin + xt.now()) / 1e3 };
    Dt = At.nowSeconds.bind(At);
    It = jt.nowSeconds.bind(jt);
    (() => {
      const { performance: e2 } = Pt;
      if (!e2 || !e2.now) return;
    ...
    tn = class {
      ...
      addBreadcrumb(e2, t2) {
        ...
        if (o2 <= 0) return;
        const a2 = { timestamp: Dt(), ...e2 }, s2 = i2 ? Oe(() => i2(a2, t2)) : a2;
      ...
      startSession(e2) {
        const { scope: t2, client: n2 } = this.getStackTop(), { release: r2, environment: i2 = Jt } = n2 && n2.getOptions() || {}, { userAgent: o2 } = be.navigator || {}, a2 = zt({ release: r2, environment: i2, user: t2.getUser(), ...o2 && { userAgent: o2 }, ...e2 }), s2 = t2.getSession && t2.getSession();
    ...
    mn = class _mn {
      ...
      sendSession(e2) {
        if (this._dsn) {
          const t2 = function(e3, t3, n2, r2) {
            const i2 = Gt(n2);
            return Lt({ sent_at: (/* @__PURE__ */ new Date()).toISOString(), ...i2 && { sdk: i2 }, ...!!r2 && { dsn: je(t3) } }, ["aggregates" in e3 ? [{ type: "sessions" }, e3] : [{ type: "session" }, e3.toJSON()]]);
      ...
      _processEvent(e2, t2, n2) {
        ...
        if (!this._isEnabled()) return Et(new Le("SDK not enabled, will not capture event.", "log"));
        const o2 = yn(e2), a2 = vn(e2), s2 = e2.type || "error", c2 = `before send for type \`${s2}\``;
        if (a2 && "number" == typeof i2 && Math.random() > i2) return this.recordDroppedEvent("sample_rate", "error", e2), Et(new Le(`Discarding event because it's not included in the random sample (sampling rate = ${i2})`, "log"));
        const l2 = "replay_event" === s2 ? "replay" : s2;
        return this._prepareEvent(e2, t2, n2).then((n3) => {
          if (null === n3) throw this.recordDroppedEvent("event_processor", l2, e2), new Le("An event processor returned `null`, will not send event.", "log");
          if (t2.data && true === t2.data.__sentry__) return n3;
          const i3 = function(e3, t3, n4) {
            const { beforeSend: r3, beforeSendTransaction: i4 } = e3;
            if (vn(t3) && r3) return r3(t3, n4);
          ...
          return function(e3, t3) {
            ...
            if (le(e3)) return e3.then((e4) => {
              if (!se(e4) && null !== e4) throw new Le(n4);
              return e4;
            }, (e4) => {
              throw new Le(`${t3} rejected with ${e4}`);
            });
            if (!se(e3) && null !== e3) throw new Le(n4);
            return e3;
          }(i3, c2);
        }).then((r3) => {
          if (null === r3) throw this.recordDroppedEvent("before_send", l2, e2), new Le(`${c2} returned \`null\`, will not send event.`, "log");
          ...
          if (e3 instanceof Le) throw e3;
          throw this.captureException(e3, { data: { __sentry__: true }, originalException: e3 }), new Le(`Event processing pipeline threw an error, original event will not be sent. Details have been sent as a new event.
Reason: ${e3}`);
        });
      }
      _process(e2) {
...
Url: ${On(e4)}`), true;
      ...
      setupOnce() {
        this.options.console && nt("console", Yn), this.options.dom && nt("dom", /* @__PURE__ */ function(e2) {
          function t2(t3) {
            ...
            i2 && i2 > $n && (("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && Ae.warn(`\`dom.maxStringLength\` cannot exceed 1024, but a value of ${i2} was configured. Sentry will use 1024 instead.`), i2 = $n), "string" == typeof r2 && (r2 = [r2]);
            try {
              const e3 = t3.event;
              n2 = function(e4) {
                return !!e4 && !!e4.target;
          ...
          return t2;
        }(this.options.dom)), this.options.xhr && nt("xhr", Jn), this.options.fetch && nt("fetch", zn), this.options.history && nt("history", Wn);
      }
    ...
    Hn = class extends mn {
      ...
      eventFromException(e2, t2) {
        return function(e3, t3, n2, r2) {
          const i2 = Bn(e3, t3, n2 && n2.syntheticException || void 0, r2);
      ...
      _flushOutcomes() {
        ...
        const t2 = (n2 = e2, Lt((r2 = this._options.tunnel && je(this._dsn)) ? { dsn: r2 } : {}, [[{ type: "client_report" }, { timestamp: i2 || Dt(), discarded_events: n2 }]]));
        var n2, r2, i2;
        this._sendEnvelope(t2);
      }
    };
    ...
    ur = class _ur {
      ...
      setupOnce(e2, t2) {
        e2((e3, n2) => {
          ...
          return ge(In, a2.stackParser, a2.maxValueLength, o2._key, o2._limit, e3, n2), e3;
        });
      }
    };
    ur.__initStatic();
    ...
    xi = "recording-started";
    ji = "recording-stopped";
    Di = "recording-stats";
    Ii = "recording-error";
    Li = "recording-upload-completed";
    Ni = "recording-data";
    Ri = "app-message";
    Fi = "transcription-message";
    Bi = "remote-media-player-started";
    ...
    zi = "network-quality-change";
    Wi = "network-connection";
    Hi = "cpu-load-change";
    Qi = "face-counts-updated";
    Ki = "fullscreen";
    Xi = "exited-fullscreen";
    Zi = "live-streaming-started";
    eo = "live-streaming-updated";
    to = "live-streaming-stopped";
    no = "live-streaming-error";
    ro = "lang-updated";
    io = "receive-settings-updated";
    oo = "input-settings-updated";
    ao = "nonfatal-error";
    so = "error";
    co = 102400;
    lo = "iframe-call-message";
    uo = "local-screen-start";
    ...
    Go = function(e2) {
      ...
      return o(r2, [{ key: "addListenerForMessagesFromCallMachine", value: function(e3, t2, n3) {
        var r3 = this, i2 = function(i3) {
          if (i3.data && "iframe-call-message" === i3.data.what && (!i3.data.callFrameId || i3.data.callFrameId === t2) && (!i3.data.from || "module" !== i3.data.from)) {
            var o2 = Vo({}, i3.data);
        ...
        var r3 = function(r4) {
          if (!(!r4.data || r4.data.what !== lo || !r4.data.action || r4.data.from && "module" !== r4.data.from || r4.data.callFrameId && t2 && r4.data.callFrameId !== t2)) {
            var i2 = r4.data;
            e3.call(n3, i2);
          }
        };
        ...
        if (!r3) throw new Error("undefined callFrameId. Are you trying to use a DailyCall instance previously destroyed?");
        var i2 = Vo({}, e3);
        if (i2.what = lo, i2.from = "module", i2.callFrameId = r3, t2) {
          var o2 = H();
        ...
        e3.what = lo, e3.callFrameId = t2, e3.from = "embedded", window.postMessage(e3, this._targetOriginFromWindowLocation());
      } }, { key: "removeListener", value: function(e3) {
        ...
        var n3 = function(n4) {
          if (n4.data && "iframe-call-message" === n4.data.what && (!n4.data.callFrameId || n4.data.callFrameId === t2) && (!n4.data.from || "module" !== n4.data.from)) {
            var r3 = n4.data;
            e3(r3);
          }
        };
    ...
    Yo = function(e2) {
      ...
      function r2() {
        var e3;
        return t(this, r2), e3 = n2.call(this), global.callMachineToDailyJsEmitter = global.callMachineToDailyJsEmitter || new v.EventEmitter(), global.dailyJsToCallMachineEmitter = global.dailyJsToCallMachineEmitter || new v.EventEmitter(), e3._wrappedListeners = {}, e3._messageCallbacks = {}, e3;
      }
      return o(r2, [{ key: "addListenerForMessagesFromCallMachine", value: function(e3, t2, n3) {
      ...
      } }, { key: "sendMessageToCallMachine", value: function(e3, t2) {
        this._sendMessage(e3, global.dailyJsToCallMachineEmitter, "sending message to call machine", t2);
      ...
      } }, { key: "_addListener", value: function(e3, t2, n3, r3) {
        var i2 = this, o2 = function(t3) {
          if (t3.callbackStamp && i2._messageCallbacks[t3.callbackStamp]) {
            var r4 = t3.callbackStamp;
            i2._messageCallbacks[r4].call(n3, t3), delete i2._messageCallbacks[r4];
          }
          e3.call(n3, t3);
        };
        this._wrappedListeners[e3] = o2, t2.addListener("message", o2);
      } }, { key: "_sendMessage", value: function(e3, t2, n3, r3) {
        if (r3) {
          var i2 = H();
          this._messageCallbacks[i2] = r3, e3.callbackStamp = i2;
        }
        t2.emit("message", e3);
      } }]), r2;
    }();
    ...
    Ho = function() {
      function e2() {
        var n2 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, r2 = n2.data, i2 = n2.mergeStrategy, o2 = void 0 === i2 ? Jo : i2;
      ...
      return o(e2, [{ key: "isNoOp", value: function() {
        ...
        return 0 === Object.keys(e3).length && t2 === zo;
      } }, { key: "_validateMergeStrategy", value: function(e3) {
        if (!Wo.includes(e3)) throw Error("Unrecognized mergeStrategy provided. Options are: [".concat(Wo, "]"));
        ...
        var r2;
        try {
          if (r2 = JSON.stringify(e3), t2 === Jo) {
            var i2 = JSON.parse(r2);
            L(i2, e3) || console.warn("The meeting session data provided will be modified when serialized.", i2, e3);
          } else if (t2 === zo) {
            for (var o2 in e3) if (Object.hasOwnProperty.call(e3, o2) && void 0 !== e3[o2]) {
              var a2 = JSON.parse(JSON.stringify(e3[o2]));
              L(e3[o2], a2) || console.warn("At least one key in the meeting session data provided will be modified when serialized.", a2, e3[o2]);
            }
          }
        } catch (e4) {
    ...
    ea = function() {
      function e2(n2) {
        t(this, e2), this._currentLoad = null, this._callFrameId = n2;
      }
      return o(e2, [{ key: "load", value: function() {
        ...
        if (this.loaded) return window._daily.instances[this._callFrameId].callMachine.reset(), void r2(true);
        e3 = this._callFrameId, window._daily.pendings.push(e3), this._currentLoad && this._currentLoad.cancel(), this._currentLoad = new ta(n2, function() {
          r2(false);
        }, function(e4, n3) {
          n3 || Zo(t2._callFrameId), i2(e4, n3);
        }), this._currentLoad.start();
      } }, { key: "cancel", value: function() {
        this._currentLoad && this._currentLoad.cancel(), Zo(this._callFrameId);
    ...
    ta = function() {
      ...
      return o(e2, [{ key: "start", value: function() {
        ...
        if (!this._currentAttempt) {
          this._currentAttempt = new ia(this._dailyConfig, this._successCallback, function t2(n2) {
            e3._currentAttempt.cancelled || (e3._attemptsRemaining--, e3._failureCallback(n2, e3._attemptsRemaining > 0), e3._attemptsRemaining <= 0 || setTimeout(function() {
              e3._currentAttempt.cancelled || (e3._currentAttempt = new ia(e3._dailyConfig, e3._successCallback, t2), e3._currentAttempt.start());
            }, 3e3));
    ...
    ia = function() {
      function e2(n3, r2, i2) {
        t(this, e2), this._loadAttemptImpl = ko() || !n3.avoidEval ? new oa(n3, r2, i2) : new aa(n3, r2, i2);
      }
      var n2;
    ...
    Ua = "video";
    Va = "voice";
    $a = ko() ? { data: {} } : { data: {}, topology: "none" };
    Ga = { present: 0, hidden: 0 };
    qa = { maxBitrate: { min: 1e5, max: 25e5 }, maxFramerate: { min: 1, max: 30 }, scaleResolutionDownBy: { min: 1, max: 8 } };
    Ya = Object.keys(qa);
    Ja = ["state", "volume", "simulcastEncodings"];
    za = { androidInCallNotification: { title: "string", subtitle: "string", iconName: "string", disableForCustomOverride: "boolean" }, disableAutoDeviceManagement: { audio: "boolean", video: "boolean" } };
    Wa = { id: { iconPath: "string", iconPathDarkMode: "string", label: "string", tooltip: "string" } };
    Ha = { id: { allow: "string", controlledBy: "'*' | 'owners' | string[]", csp: "string", iconURL: "string", label: "string", loading: "'eager' | 'lazy'", location: "'main' | 'sidebar'", name: "string", referrerPolicy: "string", sandbox: "string", src: "string", srcdoc: "string", shared: "string[] | 'owners' | boolean" } };
    Qa = { customIntegrations: { validate: vs, help: gs() }, customTrayButtons: { validate: ms, help: "customTrayButtons should be a dictionary of the type ".concat(JSON.stringify(Wa)) }, url: { validate: function(e2) {
      ...
      return us(e2, { allowAllParticipantsKey: false });
    }, help: fs({ allowAllParticipantsKey: false }) }, sendSettings: { validate: function(e2, t2) {
      return !!function(e3, t3) {
        try {
      ...
      var n2;
      return !!ds(e2) && (t2._preloadCache.inputSettings || (t2._preloadCache.inputSettings = {}), hs(e2, null === (n2 = t2.properties) || void 0 === n2 ? void 0 : n2.dailyConfig), e2.audio && (t2._preloadCache.inputSettings.audio = e2.audio), e2.video && (t2._preloadCache.inputSettings.video = e2.video), true);
    }, help: ps() }, layout: { validate: function(e2) {
    ...
    Ka = { styles: { validate: function(e2) {
      ...
      if (n2.includes(e2) || !ko() && "avatar" === e2) return true;
    ...
    Xa = function(r2) {
      c(Z2, v);
      var i2, s2, l2, u2, h2, f2, m2, y2, _2, b2, w2, S2, k2, E2, M2, T2, C2, O2, P2, A2, x2, j2, D2, I2, N2, R2, F2, B2, U2, V2, $2, G2, q2, Y2, J2, z2, Q2 = Ra(Z2);
      function Z2(e2) {
        var n2, r3, i3 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
        if (t(this, Z2), d(a(n2 = Q2.call(this)), "startListeningForDeviceChanges", function() {
          Ta(n2.handleDeviceChange);
        }), d(a(n2), "stopListeningForDeviceChanges", function() {
          Ca(n2.handleDeviceChange);
        }), d(a(n2), "handleDeviceChange", function(e3) {
          e3 = e3.map(function(e4) {
            return JSON.parse(JSON.stringify(e4));
          }), n2.emit(fi, { action: fi, availableDevices: e3 });
        }), d(a(n2), "handleNativeAppStateChange", function() {
          var e3 = p(function* (e4) {
            if ("destroyed" === e4) return console.warn("App has been destroyed before leaving the meeting. Cleaning up all the resources!"), void (yield n2.destroy());
            var t2 = "active" === e4;
            n2.disableReactNativeAutoDeviceManagement("video") || (t2 ? n2.camUnmutedBeforeLosingNativeActiveState && n2.setLocalVideo(true) : (n2.camUnmutedBeforeLosingNativeActiveState = n2.localVideo(), n2.camUnmutedBeforeLosingNativeActiveState && n2.setLocalVideo(false)));
          });
          return function(t2) {
            return e3.apply(this, arguments);
          };
        }()), d(a(n2), "handleNativeAudioFocusChange", function(e3) {
          n2.disableReactNativeAutoDeviceManagement("audio") || (n2._hasNativeAudioFocus = e3, n2.toggleParticipantAudioBasedOnNativeAudioFocus(), n2._hasNativeAudioFocus ? n2.micUnmutedBeforeLosingNativeAudioFocus && n2.setLocalAudio(true) : (n2.micUnmutedBeforeLosingNativeAudioFocus = n2.localAudio(), n2.setLocalAudio(false)));
        }), d(a(n2), "handleNativeSystemScreenCaptureStop", function() {
          n2.stopScreenShare();
        }), n2.strictMode = void 0 === i3.strictMode || i3.strictMode, xa) {
          if (n2._logDuplicateInstanceAttempt(), n2.strictMode) throw new Error("Duplicate DailyIframe instances are not allowed");
        } else r3 = a(n2), xa = r3;
        if (window._daily || (window._daily = { pendings: [], instances: {} }), n2._callFrameId = H(), window._daily.instances[n2._callFrameId] = {}, n2._sharedTracks = {}, window._daily.instances[n2._callFrameId].tracks = n2._sharedTracks, i3.dailyJsVersion = Z2.version(), n2._iframe = e2, n2._callObjectMode = "none" === i3.layout && !n2._iframe, n2._preloadCache = { subscribeToTracksAutomatically: true, audioDeviceId: null, videoDeviceId: null, outputDeviceId: null, inputSettings: null, sendSettings: null, videoTrackForNetworkConnectivityTest: null, videoTrackForConnectionQualityTest: null }, void 0 !== i3.showLocalVideo ? n2._callObjectMode ? console.error("showLocalVideo is not available in call object mode") : n2._showLocalVideo = !!i3.showLocalVideo : n2._showLocalVideo = true, void 0 !== i3.showParticipantsBar ? n2._callObjectMode ? console.error("showParticipantsBar is not available in call object mode") : n2._showParticipantsBar = !!i3.showParticipantsBar : n2._showParticipantsBar = true, void 0 !== i3.customIntegrations ? n2._callObjectMode ? console.error("customIntegrations is not available in call object mode") : n2._customIntegrations = i3.customIntegrations : n2._customIntegrations = {}, void 0 !== i3.customTrayButtons ? n2._callObjectMode ? console.error("customTrayButtons is not available in call object mode") : n2._customTrayButtons = i3.customTrayButtons : n2._customTrayButtons = {}, void 0 !== i3.activeSpeakerMode ? n2._callObjectMode ? console.error("activeSpeakerMode is not available in call object mode") : n2._activeSpeakerMode = !!i3.activeSpeakerMode : n2._activeSpeakerMode = false, i3.receiveSettings ? n2._callObjectMode ? n2._receiveSettings = i3.receiveSettings : console.error("receiveSettings is only available in call object mode") : n2._receiveSettings = {}, n2.validateProperties(i3), n2.properties = Na({}, i3), n2._preloadCache.inputSettings || (n2._preloadCache.inputSettings = {}), i3.inputSettings && i3.inputSettings.audio && (n2._preloadCache.inputSettings.audio = i3.inputSettings.audio), i3.inputSettings && i3.inputSettings.video && (n2._preloadCache.inputSettings.video = i3.inputSettings.video), n2._callObjectLoader = n2._callObjectMode ? new ea(n2._callFrameId) : null, n2._callState = br, n2._isPreparingToJoin = false, n2._accessState = { access: Dr }, n2._meetingSessionSummary = {}, n2._finalSummaryOfPrevSession = {}, n2._meetingSessionState = ws($a, n2._callObjectMode), n2._nativeInCallAudioMode = Ua, n2._participants = {}, n2._isScreenSharing = false, n2._participantCounts = Ga, n2._rmpPlayerState = {}, n2._waitingParticipants = {}, n2._network = { threshold: "good", quality: 100 }, n2._activeSpeaker = {}, n2._localAudioLevel = 0, n2._remoteParticipantsAudioLevel = {}, n2._messageChannel = ko() ? new Yo() : new Go(), n2._iframe && (n2._iframe.requestFullscreen ? n2._iframe.addEventListener("fullscreenchange", function() {
          document.fullscreenElement === n2._iframe ? (n2.emit(Ki, { action: Ki }), n2.sendMessageToCallMachine({ action: Ki })) : (n2.emit(Xi, { action: Xi }), n2.sendMessageToCallMachine({ action: Xi }));
        }) : n2._iframe.webkitRequestFullscreen && n2._iframe.addEventListener("webkitfullscreenchange", function() {
          document.webkitFullscreenElement === n2._iframe ? (n2.emit(Ki, { action: Ki }), n2.sendMessageToCallMachine({ action: Ki })) : (n2.emit(Xi, { action: Xi }), n2.sendMessageToCallMachine({ action: Xi }));
        })), ko()) {
          var o2 = n2.nativeUtils();
          o2.addAudioFocusChangeListener && o2.removeAudioFocusChangeListener && o2.addAppStateChangeListener && o2.removeAppStateChangeListener && o2.addSystemScreenCaptureStopListener && o2.removeSystemScreenCaptureStopListener || console.warn("expected (add|remove)(AudioFocusChange|AppActiveStateChange|SystemScreenCaptureStop)Listener to be available in React Native"), n2._hasNativeAudioFocus = true, o2.addAudioFocusChangeListener(n2.handleNativeAudioFocusChange), o2.addAppStateChangeListener(n2.handleNativeAppStateChange), o2.addSystemScreenCaptureStopListener(n2.handleNativeSystemScreenCaptureStop);
        }
        return n2._callObjectMode && n2.startListeningForDeviceChanges(), n2._messageChannel.addListenerForMessagesFromCallMachine(n2.handleMessageFromCallMachine, n2._callFrameId, a(n2)), n2;
      }
      return o(Z2, [{ key: "destroy", value: (z2 = p(function* () {
        var e2, t2;
        try {
          yield this.leave();
        } catch (e3) {
        ...
        xa = void 0, (null === (e2 = window) || void 0 === e2 || null === (t2 = e2._daily) || void 0 === t2 ? void 0 : t2.instances) && delete window._daily.instances[this._callFrameId], this.strictMode && (this._callFrameId = void 0);
      }), function() {
        ...
        return ss(), this.sendMessageToCallMachine({ action: "load-css", cssFile: this.absoluteUrl(n2), bodyClass: t2, cssText: r3 }), this;
      } }, { key: "iframe", value: function() {
        return ss(), this._iframe;
      } }, { key: "meetingState", value: function() {
        return this._callState;
      } }, { key: "accessState", value: function() {
        return os(this._callObjectMode, "accessState()"), this._accessState;
        ...
        return os(this._callObjectMode, "waitingParticipants()"), this._waitingParticipants;
      } }, { key: "validateParticipantProperties", value: function(e2, t2) {
        for (var n2 in t2) {
          if (!Ka[n2]) throw new Error("unrecognized updateParticipant property ".concat(n2));
          if (Ka[n2].validate && !Ka[n2].validate(t2[n2], this, this._participants[e2])) throw new Error(Ka[n2].help);
        }
      ...
      } }, { key: "updateWaitingParticipant", value: (J2 = p(function* () {
        var e2 = this, t2 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "", r3 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
        if (os(this._callObjectMode, "updateWaitingParticipant()"), es(this._callState, "updateWaitingParticipant()"), "string" != typeof t2 || "object" !== n(r3)) throw new Error("updateWaitingParticipant() must take an id string and a updates object");
      ...
      }) }, { key: "updateWaitingParticipants", value: (Y2 = p(function* () {
        var e2 = this, t2 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
        if (os(this._callObjectMode, "updateWaitingParticipants()"), es(this._callState, "updateWaitingParticipants()"), "object" !== n(t2)) throw new Error("updateWaitingParticipants() must take a mapping between ids and update objects");
      ...
      }) }, { key: "requestAccess", value: (q2 = p(function* () {
        var e2 = this, t2 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, n2 = t2.access, r3 = void 0 === n2 ? { level: Ir } : n2, i3 = t2.name, o2 = void 0 === i3 ? "" : i3;
        return os(this._callObjectMode, "requestAccess()"), es(this._callState, "requestAccess()"), new Promise(function(t3, n3) {
        ...
        return "forceDiscardTrack" in t2 && (ko() ? (console.warn("forceDiscardTrack option not supported in React Native; ignoring"), t2 = {}) : e2 && (console.warn("forceDiscardTrack option only supported when calling setLocalAudio(false); ignoring"), t2 = {})), this.sendMessageToCallMachine({ action: "local-audio", state: e2, options: t2 }), this;
      ...
      } }, { key: "getReceiveSettings", value: (G2 = p(function* (e2) {
        var t2 = this, r3 = (arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}).showInheritedValues, i3 = void 0 !== r3 && r3;
        if (os(this._callObjectMode, "getReceiveSettings()"), !this._callMachineInitialized) return this._receiveSettings;
        switch (n(e2)) {
          case "string":
      ...
      }) }, { key: "updateReceiveSettings", value: ($2 = p(function* (e2) {
        var t2 = this;
        if (os(this._callObjectMode, "updateReceiveSettings()"), !us(e2, { allowAllParticipantsKey: true })) throw new Error(fs({ allowAllParticipantsKey: true }));
        return es(this._callState, "updateReceiveSettings()", "To specify receive settings earlier, use the receiveSettings config property."), new Promise(function(n2) {
        ...
        if (e2) {
          ...
          if (e2.audio && !u3) {
            var d2 = Na({}, e2.audio.processor);
            delete d2._isDefaultWhenNone, l3.audio = Na(Na({}, e2.audio), {}, { processor: d2 });
          }
        ...
        var e2 = this;
        return ss(), new Promise(function(t2) {
        ...
        }) : this._getInputSettings()) : (console.error(ps()), Promise.reject(ps()));
      }), function(e2) {
        return V2.apply(this, arguments);
      }) }, { key: "setBandwidth", value: function(e2) {
        var t2 = e2.kbs, n2 = e2.trackConstraints;
        if (ss(), this._callMachineInitialized) return this.sendMessageToCallMachine({ action: "set-bandwidth", kbs: t2, trackConstraints: n2 }), this;
      } }, { key: "getDailyLang", value: function() {
        var e2 = this;
        if (ss(), this._callMachineInitialized) return new Promise(function(t2) {
        ...
        return ss(), this.sendMessageToCallMachine({ action: "set-daily-lang", lang: e2 }), this;
      ...
      } }, { key: "getMeetingSession", value: (U2 = p(function* () {
        var e2 = this;
        return console.warn("getMeetingSession() is deprecated: use meetingSessionSummary(), which will return immediately"), es(this._callState, "getMeetingSession()"), new Promise(function(t2) {
          e2.sendMessageToCallMachine({ action: "get-meeting-session" }, function(e3) {
            delete e3.action, delete e3.callbackStamp, delete e3.callFrameId, t2(e3);
          });
        });
      }), function() {
        return U2.apply(this, arguments);
      }) }, { key: "meetingSessionState", value: function() {
        return es(this._callState, "meetingSessionState"), this._meetingSessionState;
      } }, { key: "setMeetingSessionData", value: function(e2) {
        var t2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "replace";
        os(this._callObjectMode, "setMeetingSessionData()"), es(this._callState, "setMeetingSessionData");
        try {
          !function(e3, t3) {
            new Ho({ data: e3, mergeStrategy: t3 });
          }(e2, t2);
        } catch (e3) {
        ...
        return this.properties.userName = e2, new Promise(function(r3) {
          n2.sendMessageToCallMachine({ action: "set-user-name", name: null != e2 ? e2 : "", thisMeetingOnly: ko() || !!t2 && !!t2.thisMeetingOnly }, function(e3) {
            delete e3.action, delete e3.callbackStamp, r3(e3);
          });
        });
      } }, { key: "setUserData", value: (B2 = p(function* (e2) {
        var t2 = this;
        try {
          ls(e2);
        } catch (e3) {
        ...
        var t2 = this;
        if ("undefined" == typeof AudioWorkletNode && !ko()) throw new Error("startLocalAudioLevelObserver() is not supported on this browser");
        if (this.validateAudioLevelInterval(e2), this._callMachineInitialized) return new Promise(function(n2, r3) {
          t2.sendMessageToCallMachine({ action: "start-local-audio-level-observer", interval: e2 }, function(e3) {
            e3.error ? r3({ error: e3.error }) : n2();
          });
        });
      ...
      } }, { key: "startCamera", value: (F2 = p(function* () {
        var e2 = this, t2 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
        if (os(this._callObjectMode, "startCamera()"), ns(this._callState, this._isPreparingToJoin, "startCamera()", "Did you mean to use setLocalAudio() and/or setLocalVideo() instead?"), is(this._testCallInProgress, "startCamera()"), this.needsLoad()) try {
          yield this.load(t2);
        } catch (e3) {
          ...
          this.validateProperties(t2), this.properties = Na(Na({}, this.properties), t2);
        }
        return new Promise(function(t3) {
          e2.sendMessageToCallMachine({ action: "start-camera", properties: Za(e2.properties, e2._callFrameId), preloadCache: Za(e2._preloadCache, e2._callFrameId) }, function(e3) {
        ...
        return ss(), es(this._callState, "startCustomTrack()"), this.validateCustomTrack(t2.track, t2.mode, t2.trackName), new Promise(function(n2, r3) {
        ...
        var t2 = this;
        return ss(), es(this._callState, "stopCustomTrack()"), new Promise(function(n2) {
        ...
        var t2 = this;
        return cs(), rs(this._callMachineInitialized, "setCamera()"), new Promise(function(n2) {
          t2.sendMessageToCallMachine({ action: "set-camera", cameraDeviceId: e2 }, function(e3) {
            n2({ device: e3.device });
          });
        });
      } }, { key: "setAudioDevice", value: (R2 = p(function* (e2) {
        return cs(), this.nativeUtils().setAudioDevice(e2), { deviceId: yield this.nativeUtils().getAudioDevice() };
      }), function(e2) {
        return R2.apply(this, arguments);
        ...
        var e2 = this;
        return cs(), new Promise(function(t2) {
          e2.sendMessageToCallMachine({ action: "get-camera-facing-mode" }, function(e3) {
            t2(e3.facingMode);
          });
        });
      } }, { key: "setInputDevicesAsync", value: (N2 = p(function* (e2) {
        var t2 = this, n2 = e2.audioDeviceId, r3 = e2.videoDeviceId, i3 = e2.audioSource, o2 = e2.videoSource;
        return ss(), void 0 !== i3 && (n2 = i3), void 0 !== o2 && (r3 = o2), n2 && (this._preloadCache.audioDeviceId = n2, this._sharedTracks.audioDeviceId = n2), r3 && (this._preloadCache.videoDeviceId = r3, this._sharedTracks.videoDeviceId = r3), this._callObjectMode && this.needsLoad() ? { camera: { deviceId: this._preloadCache.videoDeviceId }, mic: { deviceId: this._preloadCache.audioDeviceId }, speaker: { deviceId: this._preloadCache.outputDeviceId } } : (n2 instanceof MediaStreamTrack && (n2 = fo), r3 instanceof MediaStreamTrack && (r3 = fo), new Promise(function(e3) {
        ...
        return N2.apply(this, arguments);
      }) }, { key: "setOutputDeviceAsync", value: (I2 = p(function* (e2) {
        var t2 = this, n2 = e2.outputDeviceId;
        return ss(), n2 && (this._preloadCache.outputDeviceId = n2), this._callObjectMode && this.needsLoad() ? { camera: { deviceId: this._preloadCache.videoDeviceId }, mic: { deviceId: this._preloadCache.audioDeviceId }, speaker: { deviceId: this._preloadCache.outputDeviceId } } : new Promise(function(e3) {
        ...
        return I2.apply(this, arguments);
      }) }, { key: "getInputDevices", value: (D2 = p(function* () {
        var e2 = this;
        ...
        return cs(), this._nativeInCallAudioMode;
      } }, { key: "setNativeInCallAudioMode", value: function(e2) {
        if (cs(), [Ua, Va].includes(e2)) {
          if (e2 !== this._nativeInCallAudioMode) return this._nativeInCallAudioMode = e2, !this.disableReactNativeAutoDeviceManagement("audio") && ts(this._callState, this._isPreparingToJoin) && this.nativeUtils().setAudioMode(this._nativeInCallAudioMode), this;
        } else console.error("invalid in-call audio mode specified: ", e2);
      } }, { key: "preAuth", value: (j2 = p(function* () {
        var e2 = this, t2 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
        if (os(this._callObjectMode, "preAuth()"), ns(this._callState, this._isPreparingToJoin, "preAuth()"), is(this._testCallInProgress, "preAuth()"), this.needsLoad() && (yield this.load(t2)), !t2.url) throw new Error("preAuth() requires at least a url to be provided");
        return this.validateProperties(t2), this.properties = Na(Na({}, this.properties), t2), new Promise(function(t3, n2) {
          e2.sendMessageToCallMachine({ action: "daily-method-preauth", properties: Za(e2.properties, e2._callFrameId), preloadCache: Za(e2._preloadCache, e2._callFrameId) }, function(r3) {
        ...
        if (this.needsLoad()) {
          ...
          if (e2 && (this.validateProperties(e2), this.properties = Na(Na({}, this.properties), e2)), !this._callObjectMode && !this.properties.url) throw new Error("can't load iframe meeting because url property isn't set");
          ...
          return this._callObjectMode ? new Promise(function(e3, n2) {
            ...
            t2._callObjectLoader.load(t2.properties.dailyConfig, function(n3) {
              t2._bundleLoadTime = n3 ? "no-op" : Date.now() - r3, t2._updateCallState(Sr), n3 && t2.emit(ci, { action: ci }), e3();
            }, function(e4, r4) {
              if (t2.emit(si, { action: si, error: e4 }), !r4) {
                t2._updateCallState(Tr), t2.resetMeetingDependentVars();
                var i3 = { action: so, errorMsg: e4.msg, error: { type: "connection-error", msg: "Failed to load call object bundle.", details: { on: "load", sourceError: e4, bundleUrl: X(t2.properties.dailyConfig) } } };
                t2._maybeSendToSentry(i3), t2.emit(so, i3), n2(e4.msg);
              }
            });
            ...
            t2._loadedCallback = function(r3) {
              t2._callState !== Tr ? (t2._updateCallState(Sr), (t2.properties.cssFile || t2.properties.cssText) && t2.loadCss(t2.properties), e3()) : n2(r3);
            };
          }));
        }
      }), function(e2) {
        return x2.apply(this, arguments);
      }) }, { key: "join", value: (A2 = p(function* () {
        var e2 = this, t2 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
        is(this._testCallInProgress, "join()");
        var n2 = false;
        if (this.needsLoad()) {
        ...
        if (void 0 !== t2.showLocalVideo && (this._callObjectMode ? console.error("showLocalVideo is not available in callObject mode") : this._showLocalVideo = !!t2.showLocalVideo), void 0 !== t2.showParticipantsBar && (this._callObjectMode ? console.error("showParticipantsBar is not available in callObject mode") : this._showParticipantsBar = !!t2.showParticipantsBar), this._callState === Er || this._callState === kr) return console.warn("already joined meeting, call leave() before joining again"), void this.updateIsPreparingToJoin(false);
        ...
        return this._preloadCache.inputSettings || (this._preloadCache.inputSettings = {}), t2.inputSettings && t2.inputSettings.audio && (this._preloadCache.inputSettings.audio = t2.inputSettings.audio), t2.inputSettings && t2.inputSettings.video && (this._preloadCache.inputSettings.video = t2.inputSettings.video), this.sendMessageToCallMachine({ action: "join-meeting", properties: Za(this.properties, this._callFrameId), preloadCache: Za(this._preloadCache, this._callFrameId) }), new Promise(function(t3, r3) {
            ...
            if (e2._callState !== Tr) {
              if (e2._updateCallState(Er), i3) for (var a2 in i3) {
                if (e2._callObjectMode) {
                  ...
                  pa(i3[a2], s3), fa(i3[a2], s3), ma(i3[a2], e2._participants[a2], s3);
                }
                e2._participants[a2] = Na({}, i3[a2]), e2.toggleParticipantAudioBasedOnNativeAudioFocus();
              }
        ...
        return A2.apply(this, arguments);
      }) }, { key: "leave", value: (P2 = p(function* () {
        var e2 = this;
        return is(this._testCallInProgress, "leave()"), new Promise(function(t2) {
          if (e2._callState === Mr || e2._callState === Tr) t2();
            ...
            t2();
          } else e2._resolveLeave = t2, e2.sendMessageToCallMachine({ action: "leave-meeting" });
        });
      }), function() {
        return P2.apply(this, arguments);
      }) }, { key: "startScreenShare", value: (O2 = p(function* () {
        var e2 = this, t2 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
        if (rs(this._callMachineInitialized, "startScreenShare()"), t2.screenVideoSendSettings && this._validateVideoSendSettings("screenVideo", t2.screenVideoSendSettings), t2.mediaStream && (this._sharedTracks.screenMediaStream = t2.mediaStream, t2.mediaStream = fo), "undefined" != typeof DailyNativeUtils && void 0 !== DailyNativeUtils.isIOS && DailyNativeUtils.isIOS) {
          var n2 = this.nativeUtils();
          if (yield n2.isScreenBeingCaptured()) return void this.emit(ao, { action: ao, type: "screen-share-error", errorMsg: "Could not start the screen sharing. The screen is already been captured!" });
        ...
        rs(this._callMachineInitialized, "stopScreenShare()"), this.sendMessageToCallMachine({ action: "local-screen-stop" });
        ...
        e2.camSimulcastEncodings && (console.warn("camSimulcastEncodings is deprecated. Use sendSettings, found in DailyCallOptions, to provide camera simulcast settings."), this.validateSimulcastEncodings(e2.camSimulcastEncodings)), e2.screenSimulcastEncodings && console.warn("screenSimulcastEncodings is deprecated. Use sendSettings, found in DailyCallOptions, to provide screen simulcast settings."), So().match(/Linux; Android/) && e2.noAutoDefaultDeviceChange && console.warn("noAutoDefaultDeviceChange is not supported on Android, and will be ignored.");
        ...
        if (e2) {
          if (!(e2 instanceof Array)) throw new Error("encodings must be an Array");
          if (!bs(e2.length, 1, 3)) throw new Error("encodings must be an Array with between 1 to ".concat(3, " layers"));
          for (var r3 = 0; r3 < e2.length; r3++) {
            ...
            for (var o2 in this._validateEncodingLayerHasValidProperties(i3), i3) if (Ya.includes(o2)) {
              ...
              if (t2) {
                ...
                if (!bs(i3[o2], s3, c2)) throw new Error("".concat(o2, " value not in range. valid range: ").concat(s3, " to ").concat(c2));
              }
      ...
      } }, { key: "startRemoteMediaPlayer", value: (C2 = p(function* (e2) {
        var t2 = this, n2 = e2.url, r3 = e2.settings, i3 = void 0 === r3 ? { state: vo.PLAY } : r3;
        try {
          !function(e3) {
            if ("string" != typeof e3) throw new Error('url parameter must be "string" type');
          }(n2), _s(i3), function(e3) {
            for (var t3 in e3) if (!Ja.includes(t3)) throw new Error("Invalid key ".concat(t3, ", valid keys are: ").concat(Ja));
            e3.simulcastEncodings && this.validateSimulcastEncodings(e3.simulcastEncodings, qa, true);
          }(i3);
        } catch (e3) {
      ...
      }) }, { key: "stopRemoteMediaPlayer", value: (T2 = p(function* (e2) {
        var t2 = this;
      ...
      }) }, { key: "updateRemoteMediaPlayer", value: (M2 = p(function* (e2) {
        ...
        var t2 = this;
        es(this._callState, "startDialOut()");
        var n2 = function(e3) {
          if (e3) {
        ...
        return new Promise(function(n3, r3) {
          t2.sendMessageToCallMachine(Na({ action: "dialout-start" }, e2), function(e3) {
        ...
        var t2 = this;
        return es(this._callState, "stopDialOut()"), new Promise(function(n2, r3) {
          t2.sendMessageToCallMachine(Na({ action: "dialout-stop" }, e2), function(e3) {
            e3.error ? r3(e3.error) : n2(e3);
          });
        });
      } }, { key: "sendDTMF", value: (k2 = p(function* (e2) {
        var t2 = this;
        return es(this._callState, "sendDTMF()"), function(e3) {
          ...
          t2.sendMessageToCallMachine(Na({ action: "send-dtmf" }, e2), function(e3) {
            e3.error ? r3(e3.error) : n2(e3);
          });
        });
      }), function(e2) {
        ...
        return new Promise(function(t2) {
          e2.sendMessageToCallMachine({ action: "get-calc-stats" }, function(n2) {
            t2(Na({ stats: n2.stats }, e2._network));
          });
        });
      } }, { key: "testWebsocketConnectivity", value: (S2 = p(function* () {
        var e2 = this;
        if (is(this._testCallInProgress, "testWebsocketConnectivity()"), this.needsLoad()) try {
          yield this.load();
        } catch (e3) {
          return Promise.reject(e3);
        }
        ...
        return e2 ? e2 instanceof MediaStreamTrack ? !!Aa(e2, { isLocalScreenVideo: false }) || (console.error("Video track is not playable. This test needs a live video track."), false) : (console.error("Video track needs to be of type `MediaStreamTrack`."), false) : (console.error("Missing video track. You must provide a video track in order to run this test."), false);
      } }, { key: "testCallQuality", value: (w2 = p(function* (t2) {
        var n2 = this;
        if (function(e2) {
          var t3 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "This daily-js method", n3 = arguments.length > 2 ? arguments[2] : void 0;
          if (e2) {
            var r4 = "".concat(t3, " can not be called after preAuth(), startCamera(), or join() and call state has been initialized.");
            throw n3 && (r4 += " ".concat(n3)), console.error(r4), new Error(r4);
          }
        }(this._callMachineInitialized, "testCallQuality()"), t2.videoTrack && !this._validateVideoTrackForNetworkTests(t2.videoTrack)) throw new Error("Video track error");
        var r3 = this._testCallAlreadyInProgress, i3 = function(e2) {
          r3 || (n2._testCallInProgress = e2);
        };
        i3(true);
        var o2 = t2.videoTrack, a2 = e(t2, ja);
        if (this._sharedTracks.videoTrackForConnectionQualityTest = o2, this.needsLoad()) try {
          var s3 = this._callState;
          yield this.load(), this._callState = s3;
        } catch (e2) {
          return i3(false), Promise.reject(e2);
        }
        return new Promise(function(t3) {
          n2.sendMessageToCallMachine(Na(Na({ action: "test-call-quality" }, a2), {}, { dailyJsVersion: n2.properties.dailyJsVersion }), function(r4) {
            var o3 = r4.results, a3 = o3.result, s4 = e(o3, Da);
            if ("failed" === a3) {
              var c2, l3 = Na({}, s4);
              null !== (c2 = s4.error) && void 0 !== c2 && c2.details ? (s4.error.details = JSON.parse(s4.error.details), l3.error = Na(Na({}, l3.error), {}, { details: Na({}, l3.error.details) }), l3.error.details.duringTest = "testCallQuality") : (l3.error = l3.error ? Na({}, l3.error) : {}, l3.error.details = { duringTest: "testCallQuality" }), n2._maybeSendToSentry(l3);
            }
            i3(false), t3(Na({ result: a3 }, s4));
          });
        });
      }), function(e2) {
        ...
        var t2 = yield this.testPeerToPeerCallQuality(e2), n2 = { result: t2.result, secondsElapsed: t2.secondsElapsed };
        ...
        var t2 = this;
        if (is(this._testCallInProgress, "testConnectionQuality()"), this.needsLoad()) try {
          yield this.load();
        } catch (e3) {
          return Promise.reject(e3);
        }
        ...
        var t2 = this;
        if (is(this._testCallInProgress, "testNetworkConnectivity()"), this.needsLoad()) try {
          yield this.load();
        } catch (e3) {
          return Promise.reject(e3);
        }
        ...
        return ss(), this._activeSpeaker;
      } }, { key: "setActiveSpeakerMode", value: function(e2) {
        return ss(), this.sendMessageToCallMachine({ action: "set-active-speaker-mode", enabled: e2 }), this;
      } }, { key: "activeSpeakerMode", value: function() {
        return ss(), this._activeSpeakerMode;
      } }, { key: "subscribeToTracksAutomatically", value: function() {
        return this._preloadCache.subscribeToTracksAutomatically;
      } }, { key: "setSubscribeToTracksAutomatically", value: function(e2) {
        return es(this._callState, "setSubscribeToTracksAutomatically()", "Use the subscribeToTracksAutomatically configuration property."), this._preloadCache.subscribeToTracksAutomatically = e2, this.sendMessageToCallMachine({ action: "daily-method-subscribe-to-tracks-automatically", enabled: e2 }), this;
      } }, { key: "enumerateDevices", value: (m2 = p(function* () {
        var e2 = this;
        if (this._callObjectMode) {
          var t2 = yield navigator.mediaDevices.enumerateDevices();
          return "Firefox" === Do() && Io().major > 115 && Io().major < 123 && (t2 = t2.filter(function(e3) {
            return "audiooutput" !== e3.kind;
          })), { devices: t2.map(function(e3) {
            var t3 = JSON.parse(JSON.stringify(e3));
            if (!ko() && "videoinput" === e3.kind && e3.getCapabilities) {
        ...
        var t2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "*";
        if (es(this._callState, "sendAppMessage()"), JSON.stringify(e2).length > 4096) throw new Error("Message data too large. Max size is 4096");
        return this.sendMessageToCallMachine({ action: "app-msg", data: e2, to: t2 }), this;
      } }, { key: "addFakeParticipant", value: function(e2) {
        return ss(), es(this._callState, "addFakeParticipant()"), this.sendMessageToCallMachine(Na({ action: "add-fake-participant" }, e2)), this;
      } }, { key: "setShowNamesMode", value: function(e2) {
        return as(this._callObjectMode, "setShowNamesMode()"), ss(), e2 && "always" !== e2 && "never" !== e2 ? (console.error('setShowNamesMode argument should be "always", "never", or false'), this) : (this.sendMessageToCallMachine({ action: "set-show-names", mode: e2 }), this);
      } }, { key: "setShowLocalVideo", value: function() {
        var e2 = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0];
        return as(this._callObjectMode, "setShowLocalVideo()"), ss(), es(this._callState, "setShowLocalVideo()"), "boolean" != typeof e2 ? (console.error("setShowLocalVideo only accepts a boolean value"), this) : (this.sendMessageToCallMachine({ action: "set-show-local-video", show: e2 }), this._showLocalVideo = e2, this);
      } }, { key: "showLocalVideo", value: function() {
        return as(this._callObjectMode, "showLocalVideo()"), ss(), this._showLocalVideo;
      } }, { key: "setShowParticipantsBar", value: function() {
        var e2 = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0];
        return as(this._callObjectMode, "setShowParticipantsBar()"), ss(), es(this._callState, "setShowParticipantsBar()"), "boolean" != typeof e2 ? (console.error("setShowParticipantsBar only accepts a boolean value"), this) : (this.sendMessageToCallMachine({ action: "set-show-participants-bar", show: e2 }), this._showParticipantsBar = e2, this);
      } }, { key: "showParticipantsBar", value: function() {
        return as(this._callObjectMode, "showParticipantsBar()"), ss(), this._showParticipantsBar;
      } }, { key: "customIntegrations", value: function() {
        return ss(), as(this._callObjectMode, "customIntegrations()"), this._customIntegrations;
      } }, { key: "setCustomIntegrations", value: function(e2) {
        return ss(), as(this._callObjectMode, "setCustomIntegrations()"), es(this._callState, "setCustomIntegrations()"), vs(e2) ? (this.sendMessageToCallMachine({ action: "set-custom-integrations", integrations: e2 }), this._customIntegrations = e2, this) : this;
      } }, { key: "startCustomIntegrations", value: function(e2) {
        var t2 = this;
        if (ss(), as(this._callObjectMode, "startCustomIntegrations()"), es(this._callState, "startCustomIntegrations()"), Array.isArray(e2) && e2.some(function(e3) {
          return "string" != typeof e3;
        ...
        var t2 = this;
        if (ss(), as(this._callObjectMode, "stopCustomIntegrations()"), es(this._callState, "stopCustomIntegrations()"), Array.isArray(e2) && e2.some(function(e3) {
          return "string" != typeof e3;
        ...
        return as(this._callObjectMode, "customTrayButtons()"), ss(), this._customTrayButtons;
      } }, { key: "updateCustomTrayButtons", value: function(e2) {
        return as(this._callObjectMode, "updateCustomTrayButtons()"), ss(), es(this._callState, "updateCustomTrayButtons()"), ms(e2) ? (this.sendMessageToCallMachine({ action: "update-custom-tray-buttons", btns: e2 }), this._customTrayButtons = e2, this) : (console.error("updateCustomTrayButtons only accepts a dictionary of the type ".concat(JSON.stringify(Wa))), this);
      } }, { key: "theme", value: function() {
        return as(this._callObjectMode, "theme()"), this.properties.theme;
      } }, { key: "setTheme", value: function(e2) {
        var t2 = this;
        return as(this._callObjectMode, "setTheme()"), new Promise(function(n2, r3) {
          try {
            t2.validateProperties({ theme: e2 }), t2.properties.theme = Na({}, e2), t2.sendMessageToCallMachine({ action: "set-theme", theme: t2.properties.theme });
            try {
              t2.emit(oi, { action: oi, theme: t2.properties.theme });
            } catch (e3) {
        ...
        if (ss(), this._iframe && !document.fullscreenElement && To()) try {
        ...
        ss(), document.fullscreenElement ? document.exitFullscreen() : document.webkitFullscreenElement && document.webkitExitFullscreen();
        ...
        return this._accessState.access === Dr || this.needsLoad() ? this.properties.url ? { roomUrlPendingJoin: this.properties.url } : null : new Promise(function(t3) {
        ...
        var t2 = this;
        return ss(), es(this._callState, "setNetworkTopology()"), new Promise(function(n2, r3) {
        ...
        if (ss(), "number" != typeof e2 && true !== e2 && false !== e2) throw new Error("argument to setShouldPlayNewParticipantSound should be true, false, or a number, but is ".concat(e2));
        this.sendMessageToCallMachine({ action: "daily-method-set-play-ding", arg: e2 });
      } }, { key: "on", value: function(e2, t2) {
        return v.prototype.on.call(this, e2, t2);
      } }, { key: "once", value: function(e2, t2) {
        return v.prototype.once.call(this, e2, t2);
      } }, { key: "off", value: function(e2, t2) {
        return v.prototype.off.call(this, e2, t2);
      } }, { key: "validateProperties", value: function(e2) {
        for (var t2 in e2) {
          if (!Qa[t2]) throw new Error("unrecognized property '".concat(t2, "'"));
          if (Qa[t2].validate && !Qa[t2].validate(e2[t2], this)) throw new Error("property '".concat(t2, "': ").concat(Qa[t2].help));
        }
      } }, { key: "assembleMeetingUrl", value: function() {
        var e2, t2, n2 = Na(Na({}, this.properties), {}, { emb: this._callFrameId, embHref: encodeURIComponent(window.location.href), proxy: null !== (e2 = this.properties.dailyConfig) && void 0 !== e2 && e2.proxyUrl ? encodeURIComponent(null === (t2 = this.properties.dailyConfig) || void 0 === t2 ? void 0 : t2.proxyUrl) : void 0 }), r3 = n2.url.match(/\?/) ? "&" : "?";
        return n2.url + r3 + Object.keys(Qa).filter(function(e3) {
          return Qa[e3].queryString && void 0 !== n2[e3];
        }).map(function(e3) {
          return "".concat(Qa[e3].queryString, "=").concat(n2[e3]);
        }).join("&");
      } }, { key: "needsLoad", value: function() {
        return [br, wr, Mr, Tr].includes(this._callState);
      } }, { key: "sendMessageToCallMachine", value: function(e2, t2) {
        if (this._destroyed && (this._logUseAfterDestroy(), this.strictMode)) throw new Error("Use after destroy");
        this._messageChannel.sendMessageToCallMachine(e2, t2, this._iframe, this._callFrameId);
        ...
        switch (t2.action) {
          ...
          case ci:
            ...
            try {
              this.emit(t2.action, t2);
            } catch (e2) {
              console.log("could not emit", t2, e2);
            }
            break;
          case hi:
            this._joinedCallback && (this._joinedCallback(t2.participants), this._joinedCallback = null);
            try {
              this.emit(t2.action, t2);
            } catch (e2) {
              console.log("could not emit", t2, e2);
          ...
          case mi:
            ...
            if (t2.participant && t2.participant.session_id) {
              var r3 = t2.participant.local ? "local" : t2.participant.session_id;
              if (this._callObjectMode) {
                var i3 = this._callMachine().store;
                pa(t2.participant, i3), fa(t2.participant, i3), ma(t2.participant, this._participants[r3], i3);
              }
              try {
                this.maybeParticipantTracksStopped(this._participants[r3], t2.participant), this.maybeParticipantTracksStarted(this._participants[r3], t2.participant), this.maybeEventRecordingStopped(this._participants[r3], t2.participant), this.maybeEventRecordingStarted(this._participants[r3], t2.participant);
              } catch (e2) {
                console.error("track events error", e2);
              }
              if (!this.compareEqualForParticipantUpdateEvent(t2.participant, this._participants[r3])) {
                this._participants[r3] = Na({}, t2.participant), this.toggleParticipantAudioBasedOnNativeAudioFocus();
                try {
                  this.emit(t2.action, t2);
                } catch (e2) {
                  console.log("could not emit", t2, e2);
          ...
          case vi:
            if (t2.participant && t2.participant.session_id) {
              var o2 = this._participants[t2.participant.session_id];
              o2 && this.maybeParticipantTracksStopped(o2, null), delete this._participants[t2.participant.session_id];
              try {
                this.emit(t2.action, t2);
              } catch (e2) {
                console.log("could not emit", t2, e2);
            ...
            break;
          case yi:
            if (!L(this._participantCounts, t2.participantCounts)) {
              this._participantCounts = t2.participantCounts;
              try {
                this.emit(t2.action, t2);
              } catch (e2) {
                console.log("could not emit", t2, e2);
            ...
            break;
          case _i:
            var a2 = { access: t2.access };
            if (t2.awaitingAccess && (a2.awaitingAccess = t2.awaitingAccess), !L(this._accessState, a2)) {
              this._accessState = a2;
              try {
                this.emit(t2.action, t2);
              } catch (e2) {
                console.log("could not emit", t2, e2);
          ...
          case bi:
            if (t2.meetingSession) {
              this._meetingSessionSummary = t2.meetingSession;
              try {
                delete t2.callFrameId, this.emit(t2.action, t2);
                var s3 = Na(Na({}, t2), {}, { action: "meeting-session-updated" });
                this.emit(s3.action, s3);
              } catch (e2) {
                console.log("could not emit", t2, e2);
              }
            }
          ...
          case so:
            var c2;
            this._iframe && !t2.preserveIframe && (this._iframe.src = ""), this._updateCallState(Tr), this.resetMeetingDependentVars(), this._loadedCallback && (this._loadedCallback(t2.errorMsg), this._loadedCallback = null), t2.preserveIframe;
            var l3 = e(t2, Ia);
            null != l3 && null !== (c2 = l3.error) && void 0 !== c2 && c2.details && (l3.error.details = JSON.parse(l3.error.details)), this._maybeSendToSentry(t2), this._joinedCallback && (this._joinedCallback(null, l3), this._joinedCallback = null);
            try {
              this.emit(t2.action, l3);
            } catch (e2) {
              console.log("could not emit", t2, e2);
            }
            break;
          ...
          case "selected-devices-updated":
            ...
            break;
          case zi:
            var u3 = t2.threshold, d2 = t2.quality;
            if (u3 !== this._network.threshold || d2 !== this._network.quality) {
              this._network.quality = d2, this._network.threshold = u3;
              try {
                this.emit(t2.action, t2);
              } catch (e2) {
                console.log("could not emit", t2, e2);
          ...
          case Hi:
            ...
            break;
          case Qi:
            if (t2 && void 0 !== t2.faceCounts) try {
              this.emit(t2.action, t2);
            } catch (e2) {
              console.log("could not emit", t2, e2);
            }
            break;
          case Yi:
            var h3 = t2.activeSpeaker;
            if (this._activeSpeaker.peerId !== h3.peerId) {
              this._activeSpeaker.peerId = h3.peerId;
              try {
                this.emit(t2.action, { action: t2.action, activeSpeaker: this._activeSpeaker });
              } catch (e2) {
                console.log("could not emit", t2, e2);
              }
            }
          ...
          case "show-local-video-changed":
            ...
            var p2 = t2.show;
            this._showLocalVideo = p2;
            try {
              this.emit(t2.action, { action: t2.action, show: p2 });
            } catch (e2) {
              console.log("could not emit", t2, e2);
            }
            break;
          case Ji:
            var f3 = t2.enabled;
            if (this._activeSpeakerMode !== f3) {
              this._activeSpeakerMode = f3;
              try {
                this.emit(t2.action, { action: t2.action, enabled: this._activeSpeakerMode });
              } catch (e2) {
                console.log("could not emit", t2, e2);
              }
            }
          ...
          case Ei:
          case Mi:
            this._waitingParticipants = t2.allWaitingParticipants;
            try {
              this.emit(t2.action, { action: t2.action, participant: t2.participant });
            } catch (e2) {
              console.log("could not emit", t2, e2);
            }
            break;
          case io:
            if (!L(this._receiveSettings, t2.receiveSettings)) {
              this._receiveSettings = t2.receiveSettings;
              try {
                this.emit(t2.action, { action: t2.action, receiveSettings: t2.receiveSettings });
              } catch (e2) {
                console.log("could not emit", t2, e2);
              }
            }
            break;
          case oo:
            if (!L(this._inputSettings, t2.inputSettings)) {
              var g2 = this._getInputSettings();
              if (this._inputSettings = t2.inputSettings, this._preloadCache.inputSettings = {}, !L(g2, this._getInputSettings())) try {
                this.emit(t2.action, { action: t2.action, inputSettings: this._getInputSettings() });
              } catch (e2) {
                console.log("could not emit", t2, e2);
              }
            }
          ...
          case "send-settings-updated":
            if (!L(this._sendSettings, t2.sendSettings)) {
              this._sendSettings = t2.sendSettings, this._preloadCache.sendSettings = null;
              try {
                this.emit(t2.action, { action: t2.action, sendSettings: t2.sendSettings });
              } catch (e2) {
                console.log("could not emit", t2, e2);
              }
            }
          ...
          case "remote-participants-audio-level":
            ...
            break;
          case Bi:
            var m3 = t2.session_id;
            this._rmpPlayerState[m3] = t2.playerState, this.emitDailyJSEvent(t2);
            break;
          case Vi:
            delete this._rmpPlayerState[t2.session_id], this.emitDailyJSEvent(t2);
            break;
          case Ui:
            var v2 = t2.session_id, y3 = this._rmpPlayerState[v2];
            y3 && this.compareEqualForRMPUpdateEvent(y3, t2.remoteMediaPlayerState) || (this._rmpPlayerState[v2] = t2.remoteMediaPlayerState, this.emitDailyJSEvent(t2));
            break;
          ...
          case "sidebar-view-changed":
            ...
            break;
          case wi:
            var _3 = this._meetingSessionState.topology !== (t2.meetingSessionState && t2.meetingSessionState.topology);
            this._meetingSessionState = ws(t2.meetingSessionState, this._callObjectMode), (this._callObjectMode || _3) && this.emitDailyJSEvent(t2);
            break;
          case $i:
        ...
        var n2 = "record";
        if (e2 && !t2.local && false === t2[n2] && e2[n2] !== t2[n2]) try {
        ...
        var n2 = "record";
        if (e2 && !t2.local && true === t2[n2] && e2[n2] !== t2[n2]) try {
          this.emit(xi, { action: xi });
        } catch (e3) {
          console.log("could not emit", e3);
        }
      } }, { key: "maybeEventTrackStopped", value: function(e2, t2, n2, r3) {
        if (e2 && ("ended" === e2.readyState || !t2 || e2.id !== t2.id)) try {
          this.emit(Ci, { action: Ci, track: e2, participant: n2, type: r3 });
        } catch (e3) {
          console.log("maybeEventTrackStopped: could not emit", e3);
        }
      } }, { key: "maybeEventTrackStarted", value: function(e2, t2, n2, r3) {
        if (t2 && (!e2 || "ended" === e2.readyState || t2.id !== e2.id)) try {
          this.emit(Ti, { action: Ti, track: t2, participant: n2, type: r3 });
        } catch (e3) {
        ...
        return !!L(e2, t2) && ((!e2.videoTrack || !t2.videoTrack || e2.videoTrack.id === t2.videoTrack.id && e2.videoTrack.muted === t2.videoTrack.muted && e2.videoTrack.enabled === t2.videoTrack.enabled) && (!e2.audioTrack || !t2.audioTrack || e2.audioTrack.id === t2.audioTrack.id && e2.audioTrack.muted === t2.audioTrack.muted && e2.audioTrack.enabled === t2.audioTrack.enabled));
        ...
        if (e2 !== this._callState || t2 !== this._isPreparingToJoin) {
          ...
          var i3 = ts(n2, r3), o2 = ts(this._callState, this._isPreparingToJoin);
        ...
        this._participants = {}, this._participantCounts = Ga, this._waitingParticipants = {}, this._activeSpeaker = {}, this._activeSpeakerMode = false, this._didPreAuth = false, this._accessState = { access: Dr }, this._finalSummaryOfPrevSession = this._meetingSessionSummary, this._meetingSessionSummary = {}, this._meetingSessionState = ws($a, this._callObjectMode), this._isScreenSharing = false, this._receiveSettings = {}, this._inputSettings = void 0, this._sendSettings = {}, this._localAudioLevel = 0, this._remoteParticipantsAudioLevel = {}, this._callMachineInitialized = false, this._bundleLoadTime = void 0, this._preloadCache;
        ...
        if (ko() && this.nativeUtils().setShowOngoingMeetingNotification) {
          ...
          i3 && (e2 = false), this.nativeUtils().setShowOngoingMeetingNotification(e2, t2, n2, r3, this._callFrameId);
        }
        ...
        if (this._callMachineInitialized) {
          var t2 = { action: po, level: "info", code: 1012, results: e2 };
          this.sendMessageToCallMachine(t2);
        ...
        if (this.needsLoad()) {
          ...
          this._messageChannel.sendMessageToCallMachine(t2, null, this._iframe, this._callFrameId);
        }
      } }, { key: "_logDuplicateInstanceAttempt", value: function() {
        var e2 = xa._callMachineInitialized ? xa : this._callMachineInitialized ? this : void 0;
        e2 ? (e2.sendMessageToCallMachine({ action: po, level: "warn", code: this.strictMode ? 9990 : 9992 }), this._delayDuplicateInstanceLog = false) : (this._delayDuplicateInstanceLog = true, xa._delayDuplicateInstanceLog = true);
        ...
        var l3, u3, d2, h3, p2, f3 = new Hn({ dsn: "https://f10f1c81e5d44a4098416c0867a8b740@o77906.ingest.sentry.io/168844", transport: Kn, integrations: [new _r.GlobalHandlers({ onunhandledrejection: false }), new _r.HttpContext()], environment: c2 }), g2 = new tn(f3, void 0, Z2.version());
        ...
        if (s3) {
          var v2 = s3.searchParams.get("domain");
          if (!v2) {
        ...
        g2.setTags({ callMode: this._callObjectMode ? ko() ? "reactNative" : null !== (r3 = this.properties) && void 0 !== r3 && null !== (i3 = r3.dailyConfig) && void 0 !== i3 && null !== (o2 = i3.callMode) && void 0 !== o2 && o2.includes("prebuilt") ? this.properties.dailyConfig.callMode : "custom" : "prebuilt-frame", version: Z2.version() });
        ...
        var e2, t2, n2;
        return null === (e2 = window._daily) || void 0 === e2 || null === (t2 = e2.instances) || void 0 === t2 || null === (n2 = t2[this._callFrameId]) || void 0 === n2 ? void 0 : n2.callMachine;
      } }], [{ key: "supportedBrowser", value: function() {
        if (ko()) return { supported: true, mobile: true, name: "React Native", version: null, supportsScreenShare: true, supportsSfu: true, supportsVideoProcessing: false, supportsAudioProcessing: false };
        var e2 = W.getParser(So());
        return { supported: !!xo(), mobile: "mobile" === e2.getPlatformType(), name: e2.getBrowserName(), version: e2.getBrowserVersion(), supportsFullscreen: !!To(), supportsScreenShare: !!Mo(), supportsSfu: !!xo(), supportsVideoProcessing: Oo(), supportsAudioProcessing: Ao() };
      } }, { key: "version", value: function() {
        return "0.66.0";
      } }, { key: "createCallObject", value: function() {
        var e2 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
        return e2.layout = "none", new Z2(null, e2);
      } }, { key: "wrap", value: function(e2) {
        var t2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
        if (ss(), !e2 || !e2.contentWindow || "string" != typeof e2.src) throw new Error("DailyIframe::Wrap needs an iframe-like first argument");
        return t2.layout || (t2.customLayout ? t2.layout = "custom-v1" : t2.layout = "browser"), new Z2(e2, t2);
      } }, { key: "createFrame", value: function(e2, t2) {
        var n2, r3;
        ss(), e2 && t2 ? (n2 = e2, r3 = t2) : e2 && e2.append ? (n2 = e2, r3 = {}) : (n2 = document.body, r3 = e2 || {});
        ...
        return t2.allow = "microphone; camera; autoplay", t2.style.cssText = "\n      position: fixed;\n      top: 0;\n      left: 0;\n      width: 100%;\n      height: 100%;\n      border: 0;\n      pointer-events: none;\n    ", document.body.appendChild(t2), e2.layout || (e2.layout = "custom-v1"), Z2.wrap(t2, e2);
...
var require_vapi = __commonJS({
  "node_modules/@vapi-ai/web/dist/vapi.js"(exports) {
    ...
    function subscribeToTracks(e2, call, isVideoRecordingEnabled) {
    ...
    var Vapi = class extends VapiEventEmitter {
      ...
      async start(assistant, assistantOverrides, squad) {
        ...
        try {
          ...
          (_b = this.call.iframe()) == null ? void 0 : _b.style.setProperty("display", "none");
          ...
          this.call.on("track-started", async (e2) => {
            ...
            if (((_b2 = e2 == null ? void 0 : e2.participant) == null ? void 0 : _b2.user_name) !== "Vapi Speaker")
              return;
          ...
          this.call.on("participant-joined", (e2) => {
            if (!e2 || !this.call)
              return;
            subscribeToTracks(e2, this.call, isVideoRecordingEnabled);
          });
